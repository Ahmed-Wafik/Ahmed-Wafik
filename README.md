...
- Skilled in **API integration**, **Firebase**, **state management**, and **performance optimization**.
- Focused on **code quality**, **testability**, and **user experience**.
- Open to **collaboration** and **relocation opportunities.**
...
<h4>MASAR</h4>
MASAR system is one of the most leading SAAS project that handles digital transformation in KSA. It offers a fine-tuned set of software, integration and cloud services to help you achieve your most ambitious goals.
 <p>
